...
function cloneSingleNode(node, options) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const windowContext = (_a = node.ownerDocument.defaultView) !== null && _a !== void 0 ? _a : window;
...
function cloneChildren(nativeNode, clonedNode, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const windowContext = (_b = nativeNode.ownerDocument.defaultView) !== null && _b !== void 0 ? _b : window;
...
function cloneInputValue(nativeNode, clonedNode) {
    var _a;
    const windowContext = (_a = nativeNode.ownerDocument.defaultView) !== null && _a !== void 0 ? _a : window;
...
function decorate(nativeNode, clonedNode) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const windowContext = (_a = clonedNode.ownerDocument.defaultView) !== null && _a !== void 0 ? _a : window;
